 ...
 * @author  __USER__
 */
public class AddLand extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Land Description");
        ...
        jCheckBox1.setText("Land Booked");
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(jSeparator2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 373, Short.MAX_VALUE)
                .addContainerGap())
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jCheckBox1)
                            .add(jTextField7, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE))
                    ...
                    .add(layout.createSequentialGroup()
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jTextField6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, jTextField4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
                            .add(jTextField3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
    ...
    private void jTextField7FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField7FocusGained
        // TODO add your handling code here:// date focus gained
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String stm = "update landdb set dobooking='"
					+ jTextField7.getText() + "', booked= 1 where landid="
					+ jTextField1.getText();
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String txt = JOptionPane.showInputDialog(this,
					"Enter Land ID : ", "Delete Land ", 1);
			Statement st = con.createStatement();
			int Lid = Integer.parseInt(txt);
			stm = "delete from landdb where landid=" + Lid;
			
			Statement st1 = con.createStatement();
			int Aid = Integer.parseInt(txt);
			String stm1 = "select * from landdb where landid=" + Aid;
			...
			if (rs.next()) {
				...
				chi = JOptionPane.showConfirmDialog(this,
						"Do you Want to Delete this ??? ", "Delete Land", 0, 1);

			} else
				{
				ch11 = JOptionPane.showConfirmDialog(this,
				
						"Land Details is not found ", "Land ", 2, 2);
			chi=1;
				}
		...
		if (chi==0)
		{
			 ...
			 chi = JOptionPane.showConfirmDialog(this,
						"Selected Record Deleted... ", "Delete Land", 0, 1);
			 BlankMe();
		}
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			String txt = JOptionPane.showInputDialog(null,
					"Enter Land ID : ", "Find Appartment ", 1);
			Statement st1 = con.createStatement();
			int Aid = Integer.parseInt(txt);
			String stm = "select * from landdb where landid=" + Aid;
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String stm = "insert into landdb values(" + jTextField1.getText()
					+ ",'" + jTextField2.getText() + "', '"
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			if (rs.next()) {
				...
				jTextField1.setText(String.valueOf("4001"));
			st.close();
			con.close();
