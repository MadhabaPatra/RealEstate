...
public class AddHouse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("House Description");
        ...
        jCheckBox1.setText("House Booked");
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String stm = "update house set dobooking='"
					+ jTextField7.getText() + "', booked= 1 where hid="
					+ jTextField1.getText();
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String txt = JOptionPane.showInputDialog(this,
					"Enter House ID : ", "Delete House ", 1);
			Statement st = con.createStatement();
			int Lid = Integer.parseInt(txt);
			stm = "delete from house where hid=" + Lid;
			
			Statement st1 = con.createStatement();
			int Aid = Integer.parseInt(txt);
			String stm1 = "select * from House where hid=" + Aid;
			...
			if (rs.next()) {
				...
				chi = JOptionPane.showConfirmDialog(this,
						"Do you Want to Delete this ??? ", "Delete HOuse", 0, 1);

			} else
				{
				ch11 = JOptionPane.showConfirmDialog(this,
				
						"House Details is not found ", "House ", 2, 2);
			chi=1;
				}
		...
		if (chi==0)
		{
			 ...
			 chi = JOptionPane.showConfirmDialog(this,
						"Selected Record Deleted... ", "Delete House", 0, 1);
			 BlankMe();
		}
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			String txt = JOptionPane.showInputDialog(null,
					"Enter HOuse ID : ", "Find House ", 1);
			Statement st1 = con.createStatement();
			int Aid = Integer.parseInt(txt);
			String stm = "select * from house where hid=" + Aid;
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String stm = "insert into House values(" + jTextField1.getText()
					+ ",'" + jTextField2.getText() + "', '"
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			if (rs.next()) {
				...
				jTextField1.setText(String.valueOf("2001"));
			st.close();
			con.close();
