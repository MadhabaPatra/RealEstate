...
public class AddOffice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Office Description");
        ...
        jCheckBox1.setText("Office Booked");
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String stm = "update office set dobooking='"
					+ jTextField7.getText() + "', booked= 1 where offid="
					+ jTextField1.getText();
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String txt = JOptionPane.showInputDialog(this,
					"Enter Office ID : ", "Delete Office ", 1);
			Statement st = con.createStatement();
			int Lid = Integer.parseInt(txt);
			stm = "delete from Office where offid=" + Lid;
			
			Statement st1 = con.createStatement();
			int Aid = Integer.parseInt(txt);
			String stm1 = "select * from office where offid=" + Aid;
			...
			if (rs.next()) {
				...
				chi = JOptionPane.showConfirmDialog(this,
						"Do you Want to Delete this ??? ", "Delete Office", 0, 1);

			} else
				{
				ch11 = JOptionPane.showConfirmDialog(this,
				
						"Office Details is not found ", "Office ", 2, 2);
			chi=1;
				}
		...
		if (chi==0)
		{
			 ...
			 chi = JOptionPane.showConfirmDialog(this,
						"Selected Record Deleted... ", "Delete Office", 0, 1);
			 BlankMe();
		}
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			String txt = JOptionPane.showInputDialog(null,
					"Enter OFFICE ID : ", "Find Office ", 1);
			Statement st1 = con.createStatement();
			int Aid = Integer.parseInt(txt);
			String stm = "select * from office where offid=" + Aid;
			...
			if (rs.next()) {
				...
				ch1 = JOptionPane.showConfirmDialog(this,
						"OFFICE is not found ", "Office ", 2, 2);
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			String stm = "insert into Office values(" + jTextField1.getText()
					+ ",'" + jTextField2.getText() + "', '"
...
"jdbc:mysql://localhost:3306/RealEstate","root","123456");  
			...
			if (rs.next()) {
				...
				jTextField1.setText(String.valueOf("6001"));
			st.close();
			con.close();
